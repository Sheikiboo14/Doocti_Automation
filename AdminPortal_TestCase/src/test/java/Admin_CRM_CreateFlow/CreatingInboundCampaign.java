...
public class CreatingInboundCampaign extends AdminLogin {
	

	
	
//String campaign_Name="Inbount Campaign";
//
//int dialprefix = 3;
//
...
//String script ="Testing";
	...
	@Test
	public void Create_InboundCampaign(String campaign_Name, int dialprefix, String industry_Name, String template_Name, String queue_Name, String pauseCode1, String pauseCode2, String pauseCode3, String dispo1, String dispo2, String dispo3,String dial1, String dial2,String dial3, String script) throws InterruptedException {
...
//Selecting Type
		...
		TypeList.findElement(By.xpath("(//div[@class='v-list__tile__title'][normalize-space()='INBOUND'])[3]")).click();
...
// Creating Campaign
	...
	// Verification
		...
		Assert.assertTrue(flag, "Inbound Campaign is not Created...!");
