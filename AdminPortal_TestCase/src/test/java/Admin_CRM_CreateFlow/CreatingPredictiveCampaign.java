...
public class CreatingPredictiveCampaign extends AdminLogin {
	...
	*/
	...
	@Parameters({"campaign_Name","dialprefix","industry_Name","template_Name","queue_Name","pauseCode1","pauseCode2","pauseCode3","dispo1","dispo2","dispo3","dial1","dial2","dial3","script","bfLevel","dialratio"})
	@Test
	public void Create_PredictiveCampaign(String campaign_Name, int dialprefix, String industry_Name, String template_Name, String queue_Name, String pauseCode1, String pauseCode2, String pauseCode3, String dispo1, String dispo2, String dispo3,String dial1, String dial2,String dial3, String script, int bfLevel, float dialratio ) throws InterruptedException {
